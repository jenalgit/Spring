package com.dawn.spring.adapter;
...
import com.dawn.spring.adapter.base.BaseListAdapter;
import com.dawn.spring.bean.BaseChatMessage;
 ...
 */
public class MessageChatAdapter extends BaseListAdapter<BaseChatMessage> {
    ...
    public MessageChatAdapter(Context context,List<BaseChatMessage> msgList) {
...
//        }
    ...
    private View createViewByType(BaseChatMessage message, int position) {
...
//        }
     ...
     * @throws
     */
    private String getImageUrl(BaseChatMessage item){
        String showUrl = "";
...
//        }
     ...
     * @throws
     */
    private void dealWithImage(int position,final ProgressBar progress_load,ImageView iv_fail_resend,TextView tv_send_status,ImageView iv_picture,BaseChatMessage item){
//        String text = item.getContent();
